...
namespace Data.Database
{
    public class UsuarioAdapter : Adapter
    {
        ...
        private static List<Business.Entities.Usuario> _Usuarios;
        ...
        public void Delete(int ID)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand sqlDelete = new SqlCommand("delete usuarios where id_usuario = @id", sqlConn);
        ...
        protected void Update(Usuario usuario)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdUpdate = new SqlCommand("UPDATE usuarios SET nombre_usuario=@nombre_usuario, clave=@clave, habilitado=@habilitado, nombre = @nombre," +
