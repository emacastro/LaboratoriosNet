    ...
    public class Usuarios
    {
        ...
        public Usuarios()
        {
            ...
            this.daUsuarios.InsertCommand = new SqlCommand("INSERT INTO usuarios(tipo_doc,nro_doc,fecha_nac,apellido, " + 
                                                           ...
                                                           " VALUES (@tipo_doc,@nro_doc,@fecha_nac,@apellido, " + 
                                                           " @nombre,@direccion,@telefono,@email,@celular,@usuario,@clave )", this.Conn);
            ...
            this.daUsuarios.DeleteCommand = new SqlCommand("DELETE FROM usuarios WHERE id=@id",this.Conn);
